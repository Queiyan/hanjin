...
{
    public partial class InfoRestrictedItemForm : Form
    {
        private WebView2 webView;
        private bool isDragging = false;
        private Point dragStartPoint;

        public InfoRestrictedItemForm()
        {
        ...
        {
            string htmlFilePath = Path.Combine(Application.StartupPath, "Resources/RestrictedItem", "anchor4.html");
